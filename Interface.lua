...
do
	...
	function AstralUI:CreatePopupFrame(width, height, title)
		return AstralUI:Popup(title, 0):Size(width, height)
	end
end
...
do
	...
	function AstralUI:CreateScrollFrame(parent,width,height,relativePoint,x,y,verticalHeight)
		return AstralUI:ScrollFrame(parent):Size(width,height):Point(relativePoint or "TOPLEFT",x,y):Height(verticalHeight)
	end
end
